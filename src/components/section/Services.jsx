...
const iconsMap = {
  ...
  "المبادرات": { iconBg: "bg-yellow-100", iconPath: "/images/initiative.png", borderColor: "border-b-yellow-400" },
  "الدورات": { iconBg: "bg-yellow-100", iconPath: "/images/courses.png", borderColor: "border-b-yellow-400" },
  "ورش العمل": { iconBg: "bg-cyan-100", iconPath: "/images/workshops.png", borderColor: "border-b-cyan-400" },
};
